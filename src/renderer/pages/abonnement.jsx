...
import NouvelAbonnementModal from '../components/NouvelAbonnementModal';
  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", gap: 6, marginTop: 10 }}>
        <button style={{ flex: 1, padding: "7px 0", fontSize: 11, background: `${accent}18`, color: accent, border: `1px solid ${accent}33`, borderRadius: 7, cursor: "pointer", fontWeight: 600, display: "flex", alignItems: "center", justifyContent: "center", gap: 4 }}>
          <Edit2 size={12} /> Modifier
        </button>
        <button style={{ padding: "7px 10px", fontSize: 11, background: "#ffffff08", color: "#666", border: "1px solid #ffffff10", borderRadius: 7, cursor: "pointer", display: "flex", alignItems: "center" }}>
          <Trash2 size={12} />
        </button>
      </div>
    </div>
          ...
          <tbody style={{ backgroundColor: "rgba(0,0,0,0.3)" }}>
            {expiryData.map((row, i) => (
              <tr key={i} style={{ borderTop: "1px solid #2a2a3a", transition: "background 0.2s" }}
                ...
                <td style={{ padding: "13px 22px" }}>
                  <button style={{ fontSize: 12, color: "#3a7bd5", background: "#3a7bd533", border: "1px solid #3a7bd544", borderRadius: 7, padding: "5px 12px", cursor: "pointer", fontWeight: 600 }}
