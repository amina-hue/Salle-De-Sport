...
const Planning = () => {
 ...
 return (
   <div style={{
     ...
     {/* Main */}
    <div style={{ flex: 1, overflowY: "auto", padding: "28px 32px",backgroundImage: `linear-gradient(rgba(11,11,18,0.6), rgba(11,11,18,0.95)), url(${gym})`,
...
backgroundRepeat: "no-repeat",
       ...
       <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 24 }}>
         <div>
           ...
           <p style={{ margin: "0 0 0 14px", color: "#FFFFFF", fontSize: 13 }}>
       ...
       <div style={{
         ...
         background: "rgba(39, 29, 31, 0.85)", border: "1px solid #ffffff08",
         ...
         <div style={{ textAlign: "center" }}>
           ...
           <div style={{ fontSize: 11, color: "#d3cccc", marginTop: 2 }}>Du {weekStart} au {weekEnd}</div>
         </div>
         ...
         <div style={{ display: "grid", background:"rgba(39, 29, 31, 0.9)",gridTemplateColumns: "64px repeat(7, 1fr)", borderBottom: "1px solid #ffffff08" }}>
           {days.map((d, i) => (
             <div key={d} style={{
               ...
               background: i === 2 ? "#dfcece" : "transparent",
         ...
         {hours.map((hour, hIdx) => (
           <div key={hour} style={{
             ...
             <div style={{
               ...
               borderRight: "1px solid #ffffff05", textAlign: "right",background:"rgba(39, 29, 31, 0.9)"
             }}>{hour}</div>
       ...
       <div style={{
         ...
         <div style={{
  display: "grid",
  gridTemplateColumns: "repeat(6, 1fr)", // 6 colonnes
